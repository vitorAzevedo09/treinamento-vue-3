    ...
    <div class="flex flex-col w-4/5 max-w-6xl py-10">
      ...
      <div v-else class="flex py-3 pl-5 mt-2 rounded justify-between items-center bg-brand-gray w-full lg:w-1/2">
        ...
        <div class="flex ml-20 mr-5" v-if="!state.hasError">
          <icon @click="handleCopy" name="copy" size="24" class="cursor-pointer" />
          <icon id="generate-apikey" @click="handleGenerateApikey" name="loading" size="24" class="cursor-pointer ml-3" />
        </div>
      </div>
