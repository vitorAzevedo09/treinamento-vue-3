    ...
    <div class="header-group">
      <div class="flex items-center justify-between py-10">
        ...
        <div class="flex gap-2">
          <button class="px-2 py-2 font-bold rounded-full text-white focus:outline-none">
            Crie uma conta
          </button>
          <button class="px-4  p-2 font-bold bg-white rounded-full text-brand-main focus:outline-none">
            Entrar
          </button>
        </div>
      </div>
      <div class="flex flex-col mt-28">
        ...
        <div>
          <button class="mt-10 px-4 p-2 font-bold bg-white rounded-full text-brand-main focus:outline-none">
